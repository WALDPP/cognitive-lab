...
export default function Home() {
  ...
  const projects = [
    ...
    {
      id: "eeg-clinical",
      title: "Adolescent Depression Screening",
      year: "Dec 2025–",
      context: "Clinical RA · Tongji University",
      question: "What neural markers distinguish MDD adolescents in a hospital inpatient setting?",
      method: "Resting-state EEG · BDI-II-C · PANAS · ATQ",
      data: "N = 157 inpatients · DSM-5 · multiscale entropy · PLI",
      insight: "Clinical data collection in psychiatric settings demands protocols that protect participants without compromising data quality.",
      translation: "Handling real clinical constraints — consent, risk screening, SOPs — is a distinct skill from lab research.",
      link: "/eeg-clinical",
    },
    {
      id: "eeg-research",
      title: "Cross-State Neural Modulation",
      year: "2025–",
      context: "Independent Design · Tongji University",
      question: "Does impaired Alpha modulation during state transitions mark depressive tendency?",
      method: "8-channel portable EEG · Alpha modulation index",
      data: "N = 140 planned · MSE · PLI · elastic net classifier",
      insight: "Transition-based indices capture neural flexibility more sensitively than single-state baselines.",
      translation: "Low-cost portable EEG with interpretable models can support community screening outside clinical settings.",
      link: "/eeg-research",
    },
    {
      id: "planwise",
